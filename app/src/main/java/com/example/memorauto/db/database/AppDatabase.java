...
@Database(entities = {Vehiculo.class, Mantenimiento.class}, version = 1)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static AppDatabase getAppDb(Context context) {
        if (INSTANCE == null) {
            INSTANCE = Room.databaseBuilder(context.getApplicationContext(), AppDatabase.class, "DB_memorauto_dev3").build();
        }
        return INSTANCE;
    }
