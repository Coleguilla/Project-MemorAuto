...
@Database(entities = {Vehiculo.class, Mantenimiento.class, Recordatorio.class}, version = 1)
...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static AppDatabase getAppDb(Context context) {
        if (INSTANCE == null) {
            INSTANCE = Room.databaseBuilder(context.getApplicationContext(), AppDatabase.class, "DB_memorauto_dev4").build();
        }
        return INSTANCE;
    }
